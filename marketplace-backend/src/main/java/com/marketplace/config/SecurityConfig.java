    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.PUT, "/api/quotes/*/deliver").hasRole("VENDOR")
                .requestMatchers(HttpMethod.PUT, "/api/quotes/*/confirm-completion").hasRole("CUSTOMER")
                .requestMatchers(HttpMethod.PUT, "/api/quotes/*/dispute").hasRole("CUSTOMER")
